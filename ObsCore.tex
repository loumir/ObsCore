...
\multicolumn{6}{|c|}{\centering OBSERVATION INFORMATION (section B.1)}\\\hline
{dataproduct\_type} &
...
\multicolumn{6}{|c|}{\centering TARGET INFORMATION (section B.2)}\\\hline
{target\_name} &
...
\multicolumn{6}{|c|}{\centering DATA DESCRIPTION (section B.3)}\\\hline
{obs\_id} &
...
\multicolumn{6}{|c|}{\centering CURATION INFORMATION (section B.4)}\\\hline
{obs\_release\_date} &
...
\multicolumn{6}{|c|}{\centering ACCESS INFORMATION (section B.5)}\\\hline
{access\_url } &
...
\multicolumn{6}{|c|}{\centering SPATIAL CHARACTERISATION (section B6.1)}\\\hline
{s\_ra } &
...
\multicolumn{6}{|c|}{\centering TIME CHARACTERISATION (section B6.3)}\\\hline
{t\_xel } &
...
\multicolumn{6}{|c|}{\centering SPECTRAL CHARACTERISATION (section B6.2)}\\\hline
{em\_xel } &
...
\multicolumn{6}{|c|}{\centering OBSERVABLE AXIS (section B6.4)}\\\hline
{o\_ucd } &
...
\multicolumn{6}{|c|}{\centering POLARIZATION CHARACTERISATION (section \ref{bkm:Ref482804077})}\\\hline
{pol\_xel } &
...
\multicolumn{6}{|c|}{\centering PROVENANCE (section \ref{bkm:Ref482804135})}\\\hline
{facility\_name} &
...
\scriptsize
\begin{tabularx}{\textwidth}{|p{0.2\textwidth}|p{0.17\textwidth}|p{0.04\textwidth}|p{0.07\textwidth}|p{0.12\textwidth}|p{0.11\textwidth}|p{0.06\textwidth}|p{0.06\textwidth}|p{0.06\textwidth}|}
\hline
...
\\\hline
\end{tabular}
\caption{TAP.schema.columns values for the mandatory fields for an ObsTAP table.
Part 1. All Utypes have the data model namespace prefix {\emph obscore:} omitted in the table..}
\label{table:tapschema-mandatory}
\end{sidewaystable}
